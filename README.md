...
- Install pytorch with cuda support IF you are using a conda environment: `conda install pytorch=1.12.1 torchvision=0.13.1 torchaudio=0.12.1 cudatoolkit=10.0 -c pytorch`
